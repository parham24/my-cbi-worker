// =================================================================
// کد کامل و نهایی ورکر - با قابلیت جلوگیری از بازخورد ناخواسته
// این کد کامل است و می‌توانید آن را مستقیماً جایگزین کنید.
// =================================================================
...
// تنها یک قطعه کد کوچک برای ارسال اعلان به افزونه اضافه شده است.
// =================================================================
            ...
            if (activeSubscribers.length > 0 && (!focusedProvince || province === focusedProvince)) {
                ...
                try {
                    const broadcastPayload = JSON.stringify({
                        ...
                        reporterId: reporterId // <<< این خط مهم و جدید است
                    });
